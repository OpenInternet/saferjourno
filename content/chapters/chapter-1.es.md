...
- Los adversarios pueden atacar a un periodista de diversas formas y por distintos motivos. Algunas amenazas habituales son
  ...
  - Intentar desacreditar al periodista y minar su reputación, para que deje de publicar contenidos o para obligarle a desconectarse.
...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | ---------------- | ---------------------------------------------------------- |
| Los participantes adquieren una visión más profunda del papel que desempeña la tecnología en su vida diaria. Los participantes comprenden cómo el uso que otros hacen de la tecnología puede ser un factor importante para su propia seguridad. Los conocimientos adquiridos en esta sesión ayudarán a los participantes a identificar los riesgos relacionados con el uso de la tecnología en las dos sesiones siguientes.

</div> <div>

❶ **Primer paso**

- Pregunte a los periodistas sobre su uso cotidiano del uso de la tecnología. Algunas preguntas clave podrían ser:
- ¿Hasta qué punto disfrutan con la tecnología?
- Cuán viejos son sus dispositivos o les gusta comprar el último gadget?
...
- Diga a los periodistas que van a pasar algún tiempo trazando en un papel las diferentes formas en que interactúan con la tecnología. Esto puede incluir: marcas y modelos de dispositivos (si los conocen), quién tiene acceso a sus dispositivos, qué tipo de cuentas en línea tienen, por ejemplo, aplicaciones de mensajería o aplicaciones de entrega de comida, y dónde se encuentran estas aplicaciones, si utilizan alguna aplicación o servicio que comparta detalles como su ubicación, a qué dispositivos se conectan en su casa, por ejemplo, su televisor.

❸ **Paso tres**

- Debate en clase sobre las formas en que los periodistas interactúan con la tecnología. Los puntos a debatir son: cómo utilizan la tecnología en el trabajo y en su vida personal, cómo influyen la familia y los amigos en la tecnología que utilizan y cómo interactúan con ella. ¿Existe alguna diferencia entre el uso que hacen de la tecnología en el trabajo y en su vida personal? Cómo su trabajo requiere tecnología y cuánto apoyo tienen de los medios de comunicación.
