...
- Website owners are able to see what IP addresses are visiting their website. Each device connected to the internet is given a unique number known as the Internet Protocol (IP) address. This number is allocated by your internet service provider, the company that provides you with your internet.
  ...
  - IP address tracking could be a problem for journalists who might not want the website owner to know that they have been looking at information on their site. If a journalist wants to hide their IP address from a website then they should use a Virtual Private Network (VPN). For more information on VPNs, see the section below.
