...
- An ISP will be able to see when a user is connected to a VPN but it will not be able to see what pages the user is visiting.
...
- Using a VPN is a good idea if the journalist does not want the website owner to know that they are visiting their site. This could, for example, be helpful if the journalist is carrying out research on and downloading reports from multinational companies or governments. While relatively rare, IP address logs have [alerted companies](https://web.archive.org/web/20211021091609/https://twitter.com/runasand/status/831266832678010880) to the fact that they are subject to a journalistic investigation. As outlined above, it's a good idea to combine a VPN with a fingerprint-resistant browser (such as the Mullvad Browser) or use the Tor Browser when conducting sensitive research.
